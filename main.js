...
for (const pet of array) {
  ...
  domString += 
  `<div id = "petCard" class="card ${pet.type === "dino" ? "text-bg-secondary mb-3" : (pet.type === "cat" ? "text-bg-success mb-3" : "text-bg-info mb-3")}" style="width: 18rem;">
